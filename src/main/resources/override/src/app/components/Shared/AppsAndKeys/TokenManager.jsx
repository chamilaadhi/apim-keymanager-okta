...
class TokenManager extends React.Component {
    ...
    generateKeys() {
        ...
        //build the additionalProperties as needed by the Okta
        //ex:
        //"{\"response_types\": \"code,token,id_token\", \"grant_types\": \"refresh_token,authorization_code,implicit,client_credentials,password\",
        //\"token_endpoint_auth_method\": \"client_secret_basic\",\"application_type\": \"web\", 
        //\"tokenGrantType\" : \"client_credentials\", \"tokenScope\": \"scope1,scope2\"}

        additionalProperties.response_types = keyRequest.responseType;
        additionalProperties.grant_types = keyRequest.supportedGrantTypes.join(",");
        //additionalProperties.grant_types = "refresh_token,authorization_code,implicit,client_credentials,password";
        additionalProperties.token_endpoint_auth_method = keyRequest.authMethod;
        additionalProperties.application_type = keyRequest.applicationType;
        additionalProperties.tokenGrantType = keyRequest.tokenGrantType;
        additionalProperties.tokenScope = keyRequest.tokenScope;
        ...
        this.application
            .then((application) => {
                return application.generateKeys(
                    ...
                    keyRequest.callbackUrl, keyRequest.validityTime, JSON.stringify(additionalProperties),
                );
            })
            .then((response) => {
